...
class Piece {
    constructor (unicode, row, column, color, id, name, travel) {
      ...
      let item = "<div class='piece' onclick='touch(\"" + this.id + "\")'>" + this.unicode + "</div>"
      document.getElementById(this.getDomId()).innerHTML = item   
    }
    ...
    getDomId() {
        // convert something like 'c0r0' into 'a1'
        let rc = "c" + this.column + "r" + this.row
        //return lookup[rc]
        return board[rc].id
    }
  }
